...
public class MainActivity extends FragmentActivity {
    ...
    private void displayView(int position) {
        ...
        switch (position) {
            ...
            case 1:
                ...
                fragmentTag ="LISTVIEW_FRAGMENT";
                break;
            case 2:
                fragment = new GridFragment();
                fragmentTag ="GRIDVIEW_FRAGMENT";
                break;
            default:
                break;
        }
    ...
    public void onResume() {
        super.onResume();
        ((ExploraApplication) this.getApplicationContext()).setMainActivity(this);
    }

    @Override
    public void onPause() {
        super.onPause();
        ((ExploraApplication) this.getApplicationContext()).setMainActivity(null);
    }
